...
interface JobFormProps {
  /** Pre-fill values for edit mode. Omit (or leave undefined) for create mode. */
  initialData?: Partial<JobFormData>;
  /** Called with the current form values when the form is submitted. */
  ...
  /** Text for the header + submit button, since "Add New Job" vs "Edit Job" differ. */
  heading: string;
  submitLabel: string;
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-6">
          ...
          <h1 className="mt-1 flex items-center gap-2 text-2xl font-bold text-[#0B2E63]">
            <span className="text-[#F5A623]">▶</span> {heading}
          </h1>
